...
Dado que ambos experimientos comparten el espacio muestral $\Omega_2 = \{2, 3, 4\} = \Omega_a$ y el orden en el que se sacan las bolas se vuelve irrelevante en $\epsilon_a$ , 
podemos decir que: 
